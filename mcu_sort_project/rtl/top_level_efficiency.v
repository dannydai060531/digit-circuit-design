// Top level for Efficiency MCU (HAS_ACCEL=0)
// Instantiates MCU core + cnt_test + IP wrappers for test_ROM/verify_RAM

module top_level_efficiency (
    input  wire         clk,
    input  wire         rst_n,
